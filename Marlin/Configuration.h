...
#define STRING_CONFIG_H_AUTHOR "(BlueKaiTheEnd, Ender-5 Plus)" // Who made the changes.
...
#define Z_MAX_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop. //ini true
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // Set to true to invert the logic of the probe. //ini true
